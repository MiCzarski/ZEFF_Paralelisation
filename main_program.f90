...
SUBROUTINE XYCALCZEFF_PARALLEL
    ...
    !$OMP PARALLEL DO PRIVATE(I, J, IMI, L, RL1, SUM0, SUM1, SUM2) SHARED(NI, NITOT, NE, ZEFF, INZ, NZ, IMX, IMY, NOIM, LSTTIM)
    DO I = 1, IMX+1 ! 10
        DO J = 1, IMY+1 ! 10
            SUM0 = 0.
            SUM1 = 0.
...
PROGRAM MainProgram
    ...
    CALL SPEED_TEST(NUMBER_OF_TESTS=10, NUMBER_OF_RUNES_PER_TEST=100000)
